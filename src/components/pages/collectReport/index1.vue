<template>
  <div id="collectReport" :style="mainListHeight()">
    <div class="collectReport" :class="['bgBanner-' + (slither + 1)]">
      ...
      <div class="footer" :class="{'footerStatic': keyUpStatus}">
...
<script>
  ...
  export default {
    name: "index",
    components: {Electrical, NoPicker, CheckChoose, RemarkTerms},
    data() {
      return {
