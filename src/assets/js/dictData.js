...
dicties = {
  ...
  // 钥匙
  key_arr: [0, 1, 2, 3, 4, 5, 6],
  // 纱窗
  shachuang: {1: '合金', 2: '塑钢', 3: '层铁窗', 4: '纱窗'},
  // 客厅灯
  drawing_light: {
    value_0: ['损坏', '无损'],
    value_1: ['1台', '2台', '3台', '4台', '5台', '6台', '7台'],
    value_2: ['共1台', '共2台', '共3台', '共4台', '共5台', '共6台', '共7台'],
  },
  // 彩电
  television: {
    value_0: ['损坏', '无损'],
  ...
  gate_lock: {
    ...
    value_1: {1: '损坏1个', 2: '损坏2个', 3: '损坏3个', 4: '损坏4个', 5: '损坏5个'},
    value_2: {1: '共1个', 2: '共2个', 3: '共3个', 4: '共4个', 5: '共5个'},
  },
};
