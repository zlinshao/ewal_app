...
dicties = {
  ...
  // 缴费类型
  water_payment_type: {0: '无', 2: '物业代缴', 3: '储值卡', 4: '水表'},
  electric_payment_type: {0: '无', 2: '物业代缴', 3: '储值卡', 5: '电表'},
  gas_payment_type: {0: '无', 2: '物业代缴', 3: '储值卡', 6: '燃气表'},
  // 转租类型
  trans_type: {0: '公司转租', 1: '个人转租'},
  // 已收金额类型
  amount_type_received: {1: '押金', 2: '押金+租金', 3: '押金+租金+其他费用'},
  // amount_type_received: {1: '押金', 2: '押金+租金', 3: '押金+租金+其他费用', 4: '定金'},
  // 是否有其他金额
